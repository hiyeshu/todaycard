...
README.md - 仓库入口文档，用自有 favicon、产品 OG 图和 shieldcn 产品数据 badge 展示项目状态，并说明运行、Dify、部署和 skill 边界
...
- 2026-06-24: 新增 README 项目入口，使用自有 favicon、产品 OG 图和有意义的 TodayCard 数据 badge，并记录本地运行、Dify、部署和 skill 边界。
